...
async function setupContracts() {
  ...
  const NonEquityCDRLBPricingStrategy = await ethers.getContractFactory("NonEquityCDRLBPricingStrategy");
  pricingStrategy = await NonEquityCDRLBPricingStrategy.deploy();
}

describe("NonEquityCDRLBPricingStrategy", function () {
  beforeEach(async () => {
